...
run() {
    ...
    if [ $DEBUG ]
    then
        java -Dbootstrap_confdir=./solr/collection1/conf -Dcollection.configName=default -DzkRun -jar start.jar &
    else
        java -Dbootstrap_confdir=./solr/collection1/conf -Dcollection.configName=default -DzkRun -jar start.jar > /dev/null 2>&1 &
    fi
...
check_version() {
    case $1 in
        4.0.0|4.1.0|4.2.0|4.2.1|4.4.0|4.5.0|4.5.1|4.6.0|4.6.1|4.7.0|4.7.1|4.7.2|4.8.0|4.8.1|4.9.0);;
        *)
